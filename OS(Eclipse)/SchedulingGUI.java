...
public class SchedulingGUI {
	...
	private void initialize() {
		...
		btnStart.setFont(new Font("Arial Black", Font.BOLD, 13));
		...
		lblBestAlgoIs.setFont(new Font("Arial Black", Font.PLAIN, 14));
		...
		lblArrivalTime.setFont(new Font("Arial Black", Font.PLAIN, 14));
		...
		lblBurstTime.setFont(new Font("Arial Black", Font.PLAIN, 14));
		...
		lblPriority.setFont(new Font("Arial Black", Font.PLAIN, 14));
		frame.getContentPane().add(lblPriority);
		
		btnFcfs = new JButton("FCFS");
		btnFcfs.setFont(new Font("Arial Black", Font.PLAIN, 13));
		...
		btnNpp.setFont(new Font("Arial Black", Font.PLAIN, 13));
		...
		btnPp.setFont(new Font("Arial Black", Font.PLAIN, 13));
		...
		btnRr.setFont(new Font("Arial Black", Font.PLAIN, 13));
		...
		btnSjnf.setFont(new Font("Arial Black", Font.PLAIN, 13));
		...
		btnSjfp.setFont(new Font("Arial Black", Font.PLAIN, 13));
