...
public class DP_GUI extends JFrame implements WindowListener,ActionListener 
{
        ...
        {        	
                ...
                text1.setBounds(211, 163, 65, 22);
                getContentPane().add(text1);
                text2.setBounds(91, 238, 75, 22);
                getContentPane().add(text2);
                text3.setBounds(137, 338, 75, 22);
                getContentPane().add(text3);
                text4.setBounds(280, 338, 75, 22);
                getContentPane().add(text4);
                text5.setBounds(342, 238, 75, 22);
                ...
                label_1.setBounds(195, 89, 91, 68);
